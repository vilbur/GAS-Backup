...
this.getFormulas = function(){
	var formulas = [
		['testFormula 1', 'testFormula_1'],
		'-',
		{'Other Formulas':[
			['testFormula 2', 'testFormula_2'],
		]},
	];
...
this.showInsertFormulasDialog = function(){
	 ...
	 */
	function iterateObject (_items_object) {
...
/** Insert given formula to current range
 * @param string formula_name name of formula function
*/
function insertFormula_post(formula_name){
	SpreadsheetApp.getActiveSpreadsheet().getActiveRange().setFormula('='+formula_name+'("value")');	
}
